...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "Objective Quality Assessment Toolkit documentation" /productName "Objective Quality Assessment Toolkit documentation" > NUL
