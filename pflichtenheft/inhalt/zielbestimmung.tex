...
\nItem{WK} Einstellungsparameter für Filter können abgespeichert und geladen werden.\\
\nItem{WK} Für einen ausgewählten Filter wird, im Visualisierungsbereich, eine Vorschau generiert.\\
\nItem{WK} Ein Filtervorgang kann mehrere Filter beinhalten. Die Reihenfolge in der Filter angewandt
