...
\nItem{PF} \gls{OQAT} stellt dem Nutzer eine Interaktive Benutzeroberfläche zur Verfügung, die
...
\nItem{PF} Um \gls{OQAT} verwenden zu können muss der Benutzer ein neues Projekt anlegen oder aber
...
% Muss es hier hiin ? In den Musskriterien ist das gleiche drin. -> entweder hier genauer oder aber
% unnötig
